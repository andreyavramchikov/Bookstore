COUNTRIES = [('', 'Select a country'),('AX', 'AALAND ISLANDS'), ('AF', 'AFGHANISTAN'), ('AL', 'ALBANIA'),
             ...
             ('CD', 'CONGO, Democratic Republic of (was Zaire)'), ('CG', 'CONGO, Republic of'),
             ('CK', 'COOK ISLANDS'), ('CR', 'COSTA RICA'), ('CI', "COTE D'IVOIRE"),
             ('HR', 'CROATIA (local name: Hrvatska)'), ('CU', 'CUBA'), ('CY', 'CYPRUS'),
             ...
             ('LK', 'SRI LANKA'), ('SD', 'SUDAN'), ('SR', 'SURINAME'), ('SJ', 'SVALBARD AND JAN MAYEN ISLANDS'),
             ('SZ', 'SWAZILAND'), ('SE', 'SWEDEN'), ('CH', 'SWITZERLAND'), ('SY', 'SYRIAN ARAB REPUBLIC'),
             ('TW', 'TAIWAN'), ('TJ', 'TAJIKISTAN'), ('TZ', 'TANZANIA, UNITED REPUBLIC OF'), ('TH', 'THAILAND'),
             ('TI', 'TIBET'), ('TL', 'TIMOR-LESTE'), ('TG', 'TOGO'), ('TK', 'TOKELAU'), ('TO', 'TONGA'),
             ...
             ('VU', 'VANUATU'), ('VA', 'VATICAN CITY STATE (HOLY SEE)'), ('VE', 'VENEZUELA'), ('VN', 'VIET NAM'),
...
STATES = [('', 'Select a state'), ('AL', 'ALABAMA'),
          ('AK', 'ALASKA'),
          #('AS', 'AMERICAN SAMOA'),
          ('AZ', 'ARIZONA'),
